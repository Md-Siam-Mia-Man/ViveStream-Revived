...
describe('Large File Manager Logic', () => {
    ...
    function joinFile(firstChunkPath, fs) {
        ...
        const files = [`${path.basename(originalPath)}.chunk001`, `${path.basename(originalPath)}.chunk002`];
    ...
    test('Algorithm: splitFile should create chunks and delete original', () => {
        ...
        expect(mockFs.writeFileSync).toHaveBeenCalledWith(`${file}.chunk001`, expect.any(String));
